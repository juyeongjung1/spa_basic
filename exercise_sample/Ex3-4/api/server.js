...
app.post('/api/employees',(req,res)=>{
    ...
    if(!password||!name||!salary){res.status(400).json({error:'必須項目が不足しています'});return;}
    // ?はparamsの値へ順番に置き換わります。
    const sql='INSERT INTO employee (password,name,salary,location_name,image_path) VALUES (?,?,?,?,?)';

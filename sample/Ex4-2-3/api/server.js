...
// 商品一覧・キーワード検索
app.get('/api/v423/products', (req, res) => {
...
// 商品詳細
app.get('/api/v423/products/:id', (req, res) => {
...
// 商品登録
app.post('/api/v423/products', (req, res) => {
...
// 商品更新
app.put('/api/v423/products/:id', (req, res) => {
    const id = req.params.id;
    const name = req.body.name;
    const price = req.body.price;
    const category = req.body.category;
...
// 商品削除
app.delete('/api/v423/products/:id', (req, res) => {
    const id = req.params.id;
